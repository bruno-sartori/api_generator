...
describe('Generators: Controllers', () => {
	describe('Generate controller files: generate()', () => {
		it('should save generated controllers in path', () => {
			const ControllerGenerator = {
				generate: td.function(),
			};
			...
			td.when(ControllerGenerator.generate({})).thenResolve(expectedResponse);

			const controllerGenerator = new ControllerGene(Books);
